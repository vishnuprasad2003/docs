...
### **Get Term Sheet**
```http
GET /cf/getTermSheet/:termSheetId
Authorization: Bearer <token>
```

### **Update Term Sheet**
```http
PUT /cf/updateTermSheet/:termSheetId
Authorization: Bearer <token>
Content-Type: application/json
...
### **Submit Term Sheet**
```http
POST /cf/submitTermSheet/:termSheetId
Authorization: Bearer <token>
```
...
<Card title="API Documentation" icon="code" href="/api-reference/credit-facility/term-sheet-apis">
