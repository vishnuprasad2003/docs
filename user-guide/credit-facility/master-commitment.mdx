...
```http
GET /cf/master-commitments/:masterCommitmentId
Authorization: Bearer <token>
```

### **Auto-Save Field**
```http
POST /cf/autoSaveField/:masterCommitmentId
Authorization: Bearer <token>
...
```http
POST /cf/createMasterCommitment
Authorization: Bearer <token>
Content-Type: application/json
...
<Card title="API Documentation" icon="code" href="/api-reference/credit-facility/master-commitment-apis">
  Explore master commitment API endpoints
</Card>
