...
<Card title="Complete Workflow Guide" icon="route" href="/user-guide/securitization/workflow-overview">
  View the complete phase-by-phase securitization workflow
</Card>

<Card title="Whole Loan Flow" icon="hand-holding-usd" href="/user-guide/whole-loan/workflow-overview">
  Learn about whole loan transactions
</Card>

<Card title="Preview & Verification" icon="check-circle" href="/user-guide/preview/workflow-overview">
  Understand preview and verification process
</Card>
